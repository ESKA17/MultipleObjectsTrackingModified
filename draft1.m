close all; imaqreset
MotionBasedMultiObjectDraft1();
function MotionBasedMultiObjectDraft1()
...
while frame_count < numFrames + 1
    ...
    [bboxes, centroids, pts, linepts, myang, refbbox] = improc();
...
%% Image processing
function [bboxes, centroids, pts, linepts, myang, refbbox, Isub] = improc()
...
else, linepts = [0 0 0 0]; myang = 0; refbbox = [0 0 0 0];
